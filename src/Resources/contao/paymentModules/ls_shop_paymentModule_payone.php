...
use function LeadingSystems\Helpers\ls_sub;
	...
	class ls_shop_paymentModule_payone extends ls_shop_paymentModule_standard {
		...
		public function modifyConfirmOrderForm($str_form = '') {
			$outputToAdd = '<div class="confirmCheckoutMessagePayone"><img src="system/modules/zzz_merconis/images/payment/payone_logo_small.png" alt="PAYONE">'.$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['payone']['confirmCheckoutMessage'].'</div>';
			...
			<div class="paymentDetails payone">
				<h2>
					<a href="https://www.payone.de/" target="_blank">
						<img src="system/modules/zzz_merconis/images/payment/payone_logo_small.png" alt="PAYONE">
					</a>
