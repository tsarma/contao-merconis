	...
	'list' => array(
		...
		'operations' => array(
			...
			(
				...
				'icon'                => 'system/modules/zzz_merconis/images/icons/editVariants.png',
			...
			(
				...
				'href'                => 'act=edit',
				'icon'                => 'system/modules/zzz_merconis/images/icons/editProduct.png'
			),
			'copy' => array(
	...
	'fields' => array(
		...
		'flex_contents' => array(
			...
			'eval'                    => array(
				...
				'label02' => &$GLOBALS['TL_LANG']['tl_ls_shop_product']['flex_contents_label02'],
		...
		'flex_contentsLanguageIndependent' => array(
			...
			'eval'                    => array(
				...
				'label02' => &$GLOBALS['TL_LANG']['tl_ls_shop_product']['flex_contentsLanguageIndependent_label02'],
				'preserveTags' => true
			)
		),
