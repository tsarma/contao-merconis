<?php
	 ...
	 * Fields
	 */
	$GLOBALS['TL_LANG']['tl_page']['ls_shop_currencyBeforeValue']		= array('Show currency before value');
	...
	$GLOBALS['TL_LANG']['tl_page']['lsShopOutputDefinitionSet']['reference'] = array(
		'-' => array('Use default ( - )', 'Select this option if you do not require a page-specific display setting differing from the default setting. The default setting is the setting that has been allocated to a superior page, or - if no special settings for superior pages have been made - the basic shop setting.')
	);
	
	/*
	 * Legends
	 */
	$GLOBALS['TL_LANG']['tl_page']['lsShop_legend']									= 'Shop settings';
