<?php
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_productDetailsTopInsertPages']	= array('Page &quot;Contents to be displayed above the product detail view&quot;', 'Select the page here of which the contents shall be displayed above the product detail view. Should you run a multilingual shop, please select the corresponding page for each language.');
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_productDetailsBottomInsertPages']	= array('Page &quot;Contents to be displayed below the product detail view&quot;', 'Select the page here of which the contents shall be displayed below the product detail view. Should you run a multilingual shop, please select the corresponding page for each language.');
