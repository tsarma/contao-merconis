<?php
    ...
    $GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_useProductDescriptionAsSeoDescription'] = array('Use product description as meta description', 'Select this checkbox if you want the product description to be used as the meta page description. If available, the product short description will be used, otherwise the long description will be used. If no product description exists at all, the regular page description provided by contao will be used.');
