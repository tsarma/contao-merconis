<?php
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_productDetailsTopInsertPages']	= array('Seite &quot;Einf&uuml;gungen &uuml;ber Produkt-Detailansichten&quot;', 'W&auml;hlen Sie hier die Seite aus, deren Seiteninhalte &uuml;ber den Produktdetailansichten dargestellt werden sollen. Falls Sie einen mehrsprachigen Shop betreiben, w&auml;hlen Sie bitte f&uuml;r jede Sprache die entsprechende Seite aus.');
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_productDetailsBottomInsertPages']	= array('Seite &quot;Einf&uuml;gungen unter Produkt-Detailansichten&quot;', 'W&auml;hlen Sie hier die Seite aus, deren Seiteninhalte unter den Produktdetailansichten dargestellt werden sollen. Falls Sie einen mehrsprachigen Shop betreiben, w&auml;hlen Sie bitte f&uuml;r jede Sprache die entsprechende Seite aus.');
