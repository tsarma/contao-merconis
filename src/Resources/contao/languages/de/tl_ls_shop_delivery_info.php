<?php
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_delivery_info']['useStock']									= array('Lagerbestand berücksichtigen');
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_delivery_info']['alertWhenLowerThanMinimumStock']			= array('E-Mail-Benachrichtigung bei Unterschreiten des minimalen Lagerbestandes', 'Die E-Mail-Benachrichtigung wird an die Adresse gesendet, die in den Grundeinstellungen auch für den Bestelleingang definiert ist.');
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_delivery_info']['delete']        = array('Datensatz löschen', 'Datensatz ID %s löschen');
