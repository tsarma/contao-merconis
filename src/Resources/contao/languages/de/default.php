...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText133'] = 'Bitte legen Sie die Produkte, die Sie kaufen möchten, in den Warenkorb.';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText138'] = 'Adresse bearbeiten';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['importErrors'] = array(
	'notExistingDataType' => 'In der/den Zeile(n) wurde ein unbekannter Datensatztyp angegeben: Nr. %s',
	'missingProductcode' => 'In der/den Zeile(n) fehlt die Artikelnummer: Nr. %s',
	'missingProductName' => 'In der/den Zeile(n) fehlt die Bezeichnung: Nr. %s',
	'missingTaxClass' =>  'In der/den Zeile(n) ist die angegebene Steuerklasse fehlerhaft: Nr. %s',
