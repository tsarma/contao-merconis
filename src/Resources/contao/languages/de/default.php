...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText012'] = 'Lieferung';

$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText013'] = 'Artikelbezeichnung';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText042'] = 'Gesamtwarenwert';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText043'] = 'Der Warenkorb ist leer.';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText044'] = '%s Produkt im Warenkorb';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText045'] = '%s Produkte im Warenkorb';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText046'] = 'zum Warenkorb';

$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText047'] = 'Brutto-Warenwert';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText047-01'] = 'Brutto-Warenwert + Gutschein';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText047-02'] = 'Brutto-Warenwert + Versandkosten';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText047-03'] = 'Brutto-Warenwert + Gutschein + Versandkosten';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText048'] = 'Netto-Warenwert';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText048-01'] = 'Netto-Warenwert + Gutschein';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText063'] = 'SUCHEN';

$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText064'] = 'Auf Facebook teilen';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText065'] = 'Auf Twitter teilen';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText066'] = 'Auf Google+ teilen:';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText067'] = 'hier-empfaenger@einsetzen.de';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText068'] = 'Webseitenempfehlung';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText069'] = 'Ich empfehle Ihnen folgende Webseite';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText070'] = 'Per E-Mail empfehlen';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText076'] = 'RECHNUNG';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText077'] = 'Nummer';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText078'] = 'Datum';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText079'] = 'Kunden-Nr.';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText080'] = 'Seite';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText081'] = '%s von %s';

$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText082'] = 'Konfigurator Ref.:';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText101'] = 'Es gibt weitere Varianten, die aufgrund Ihrer Filter-Einstellungen nicht angezeigt werden.';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['price'] = 'Preis';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['basePrice'] = 'Basispreis';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['configuratorPrice'] = 'zzgl. Konfiguration';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['finalPrice'] = 'Endpreis';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['checkoutFlow']['shippingSelection'] = 'Versand';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['checkoutFlow']['shippingAndPaymentSelection'] = 'Versand und Zahlung';
...
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['saferpay']['paymentMeans'] = 'Zahlungsmittel';
...
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['vrpay']['paymentBrand'] = 'Zahlungsmittel';

$GLOBALS['TL_LANG']['MOD']['ls_shop']['customLogicExample']['noIndividualConfigurationUsed'] = 'Ihr Produkt wird nicht individuell bedruckt.';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['customLogicExample']['summaryTextPart01'] = 'Wir werden';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['customLogicExample']['summaryTextPart02'] = 'Ihr Logo';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['customLogicExample']['summaryTextPart03'] = 'und';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['customLogicExample']['summaryTextPart04'] = 'Ihren Text';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['customLogicExample']['summaryTextPart05'] = 'Zeichen zu je';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['customerData']['fieldNames'] = array(
	...
	'useDeviantShippingAddress' => 'Abweichende Versandadresse benutzen',
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['orderSortingOptions']['orderDateUnixTimestamp'] = 'Datum';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['orderSortingOptions']['orderNr'] = 'Bestellungsnr.';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['orderSortingOptions']['invoicedAmount'] = 'Rechnungsbetrag';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['orderSortingOptions']['status01'] = 'Bearbeitungsstatus';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['orderSortingOptions']['status02'] = 'Zahlung eingegangen';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['stockNotificationSubject'] = 'Achtung: Geringer Lagerbestand';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['stockNotificationText'] = "Achtung: Für das Produkt
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['importer'] = array(
	...
	'misc' => array(
		...
		'processedVariantLanguages' => 'Variantensprachen verarbeiten',
		'importInterrupted' => 'Der Import wurde unterbrochen',
		'recommendedProductTranslation' => 'Verarbeitung empfohlener Produkte',
		'finished' => 'erledigt'
	)
);
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['importText24'] = 'Varianten';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['importText25'] = 'Produktsprachen';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['importText26'] = 'Variantensprachen';

$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['importErrors'] = array(
	'notExistingDataType' => 'In der/den Zeile(n) Nr. %s wurde ein unbekannter Datensatztyp angegeben.',
	'missingProductcode' => 'In der/den Zeile(n) Nr. %s fehlt die Artikelnummer.',
	'missingProductName' => 'In der/den Zeile(n) Nr. %s fehlt die Bezeichnung.',
	'missingTaxClass' =>  'In der/den Zeile(n) Nr. %s ist die angegebene Steuerklasse fehlerhaft.',

	'missingTemplate' => 'In der/den Zeile(n) Nr. %s wurde kein Template angegeben.',

	'variantIncorrectParentProductcode' => 'In der/den Zeile(n) Nr. %s wurde zu einer Variante eine &uuml;bergeordnete Artikelnummer angegeben, zu der es in der Import-Datei keine Entsprechung gibt.',
	'variantLanguageIncorrectParentProductcode' => 'In der/den Zeile(n) Nr. %s wurde zu einer Variantensprache eine &uuml;bergeordnete Artikelnummer angegeben, zu der es in der Import-Datei keine Entsprechung gibt.',
	'productLanguageIncorrectParentProductcode' => 'In der/den Zeile(n) Nr. %s wurde zu einer Produktsprache eine &uuml;bergeordnete Artikelnummer angegeben, zu der es in der Import-Datei keine Entsprechung gibt.',
	'missingOrWrongLanguagecode' => 'In der/den Zeile(n) Nr. %s wurde eine im Shop nicht genutzte Sprache eingetragen.',
	'notExistingAttribute' => 'In der/den Zeile(n) Nr. %s wurde ein Merkmal angegeben, das im Shop nicht angelegt ist.',
	'notExistingAttributeValue' =>  'In der/den Zeile(n) Nr. %s wurde eine Auspr&auml;gung angegeben, die im Shop nicht angelegt ist.',
	'notMatchingAttributesAndValues' =>  'In der/den Zeile(n) Nr. %s wurde eine Auspr&auml;gung angegeben, die nicht zum Merkmal passt.',
	'notExistingCategory' => 'In der/den Zeile(n) Nr. %s wurde eine Kategorie angegeben, zu der keine entsprechende Seite im Shop existiert.',
	'notExistingPriceType' => 'In der/den Zeile(n) Nr. %s wurde ein ung&uuml;ltiger Wert im Feld "Preis: Art der Preisangabe" angegeben.',
	'notExistingPriceTypeOld' => 'In der/den Zeile(n) Nr. %s wurde ein ung&uuml;ltiger Wert im Feld "Alter Preis: Art der Preisangabe" angegeben.',
	'notExistingWeightType' => 'In der/den Zeile(n) Nr. %s wurde ein ung&uuml;ltiger Wert im Feld "Art der Gewichtsangabe" angegeben.',
	'notExistingDeliveryInfoType' => 'In der/den Zeile(n) Nr. %s wurde eine &quot;Einstellung zu Lagerbestand und Lieferzeit&quot; hinterlegt, welche im Shop nicht angelegt ist.',
	'wrongStockValue' => 'In der/den Zeile(n) Nr. %s liegt eine inkorrekte Lagerbestandsangabe vor. Erlaubt sind Zahlen sowie die Zeichen &quot;+&quot; (Plus), &quot;-&quot; (Minus) und &quot;.&quot; (Punkt als Dezimaltrennzeichen).',
	...
	'valueInvalid_name' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;name&quot; ist ung&uuml;ltig (max. 255 Zeichen sind erlaubt)',
	'variantValueInvalid_name' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;name&quot; ist ung&uuml;ltig (max. 255 Zeichen sind erlaubt)',
	'valueInvalid_sorting' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;sorting&quot; ist ung&uuml;ltig (muss ein Integer sein)',
	'variantValueInvalid_sorting' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;sorting&quot; ist ung&uuml;ltig (muss ein Integer sein)',
	'valueInvalid_price' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;price&quot; ist ung&uuml;ltig (muss ein Dezimalwert sein (0-9, Dezimalpunkt und Minuszeichen sind erlaubt))',
	'variantValueInvalid_price' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;price&quot; ist ung&uuml;ltig (muss ein Dezimalwert sein (0-9, Dezimalpunkt und Minuszeichen sind erlaubt))',
	'valueInvalid_oldPrice' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;oldPrice&quot; ist ung&uuml;ltig (muss ein Dezimalwert sein (0-9, Dezimalpunkt und Minuszeichen sind erlaubt))',
	'variantValueInvalid_oldPrice' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;oldPrice&quot; ist ung&uuml;ltig (muss ein Dezimalwert sein (0-9, Dezimalpunkt und Minuszeichen sind erlaubt))',
	'valueInvalid_weight' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;weight&quot; ist ung&uuml;ltig (muss ein Dezimalwert sein (0-9, Dezimalpunkt und Minuszeichen sind erlaubt))',
	'variantValueInvalid_weight' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;weight&quot; ist ung&uuml;ltig (muss ein Dezimalwert sein (0-9, Dezimalpunkt und Minuszeichen sind erlaubt))',
	'valueInvalid_unit' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;unit&quot; ist ung&uuml;ltig (max. 255 Zeichen sind erlaubt)',
	'productValueInvalid_quantityDecimals' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;quantityDecimals&quot; ist ung&uuml;ltig (muss ein Integer sein)',
	'valueInvalid_quantityComparisonUnit' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;quantityComparisonUnit&quot; ist ung&uuml;ltig (max. 255 Zeichen sind erlaubt)',
	'valueInvalid_quantityComparisonDivisor' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;quantityComparisonDivisor&quot; ist ung&uuml;ltig (muss ein Dezimalwert sein (0-9, Dezimalpunkt und Minuszeichen sind erlaubt))',
	'productValueInvalid_template' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;template&quot; ist ung&uuml;ltig (max. 64 Zeichen sind erlaubt)',
	'productValueInvalid_producer' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;producer&quot; ist ung&uuml;ltig (max. 255 Zeichen sind erlaubt)',
	'valueInvalid_productcode' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;productcode&quot; ist ung&uuml;ltig (max. 255 Zeichen sind erlaubt)',
	'variantValueInvalid_productcode' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;productcode&quot; ist ung&uuml;ltig (max. 255 Zeichen sind erlaubt)',
	'valueInvalid_scalePriceType' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;scalePriceType&quot; ist ung&uuml;ltig',
	'valueInvalid_scalePriceQuantityDetectionMethod' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;scalePriceQuantityDetectionMethod&quot; ist ung&uuml;ltig',
	'valueInvalid_scalePriceKeyword' => 'Zeile(n) Nr. %s: Feldwert f&uuml;r &quot;scalePriceKeyword&quot; ist ung&uuml;ltig'
);

$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-01'] = '<h2 class="merconisInstallerHeadline">MERCONIS-INSTALLER</h2><h2>Herzlichen Gl&uuml;ckwunsch,</h2><p>Sie haben eine gute Wahl getroffen und MERCONIS in Ihr Modul-Verzeichnis kopiert.</p><p class="shopHint"><strong>Hinweis:</strong> Bitte folgen Sie nun den Installationsanweisungen, deaktivieren Sie den internen Contao-Cache während der Installation und f&uuml;hren Sie keine anderen Backend-Aktivit&auml;ten durch. Bis zum vollst&auml;ndigen Abschluss der MERCONIS-Installation arbeiten einige Contao-Grundfunktionen m&ouml;glicherweise fehlerhaft, da noch nicht alle relevanten Einstellungen vorgenommen wurden.</p><p>Der MERCONIS-Installer wird in Ihrem bestehenden Contao-Projekt vollautomatisch alle ben&ouml;tigten Seiten, Artikel, Module und Formulare anlegen und Demo-Daten einf&uuml;gen. F&uuml;r weitere Informationen verweisen wir auf das Online-Handbuch.</p><p><a href="%s">Installation beginnen</a></p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-02'] = '<h2 class="merconisInstallerHeadline">MERCONIS-INSTALLER</h2><p>Bitte f&uuml;hren Sie nun das <a href="%s">Contao-Install-Tool</a> aus.</p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-03'] = '<h2 class="merconisInstallerHeadline">MERCONIS-INSTALLER</h2><p>MERCONIS ist noch nicht vollst&auml;ndig eingerichtet. Klicken Sie <a href="%s">hier</a>, um die automatische Einrichtung durchzuf&uuml;hren.</p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-04'] = '<h2 class="merconisInstallerHeadline">MERCONIS-INSTALLER</h2><p>Sie haben in Contao noch keine Seite vom Typ "Startpunkt einer Webseite" eingerichtet. Bitte stellen Sie sicher, dass eine solche Seite existiert, bevor Sie die Installation des Shops durchf&uuml;hren.</p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-05'] = '<h2 class="merconisInstallerHeadline">MERCONIS-INSTALLER</h2><p>Sie haben in Contao noch kein Theme angelegt. Bitte legen Sie ein Theme an, bevor Sie die Installation des Shops durchf&uuml;hren, da die Shop-Module einem Theme zugeordnet werden m&uuml;ssen.</p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-06'] = '<h2 class="merconisInstallerHeadline">MERCONIS-INSTALLER</h2><p>MERCONIS ist noch nicht vollst&auml;ndig eingerichtet. Bitte w&auml;hlen Sie, mit welchem Theme Sie MERCONIS einrichten m&ouml;chten.</p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-07'] = 'Mit gew&auml;hltem Theme einrichten';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-08'] = 'Live-Vorschau';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-09'] = 'Es stehen keine Themes zur Verf&uuml;gung, bitte kontaktieren Sie den MERCONIS Support, um das Problem zu beheben.';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-10'] = 'Dieses Theme ist nur kompatibel mit Contao %s';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-11'] = 'Dieses Theme ist nur kompatibel mit MERCONIS %s';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-12'] = 'Das von Ihnen gew&auml;hlte Theme kann nicht eingerichtet werden. Bitte kontaktieren Sie den MERCONIS Support, um das Problem zu beheben, oder w&auml;hlen Sie ein anderes Theme.';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-13'] = 'Bitte w&auml;hlen Sie ein Theme';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-16'] = 'Der direkte Zugriff auf das Online-Theme-Repository ist aktuell nicht m&ouml;glich%s. Sollten Sie ein anderes Theme als das bereits mitgelieferte Theme &quot;Basic&quot; verwenden wollen, besuchen Sie bitte zun&auml;chst <a target="_blank" href="http://themes.merconis.com">themes.merconis.com</a>, laden das gew&uuml;nschte Theme dort herunter und setzen danach die Installation fort.';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-17'] = 'CURL-Erweiterung nicht verf&uuml;gbar';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-18'] = 'Keine Daten empfangen';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage01-19'] = 'Der Abruf eines Themes aus dem Online Theme Repository dauert &uuml;blicherweise nur einige Sekunden, kann aber abh&auml;ngig von der Internetverbindung unter Umst&auml;nden bis zu einer Minute dauern.';

$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage07'] = '<h2>MERCONIS %s ist vollst&auml;ndig eingerichtet!</h2><p>Sie k&ouml;nnen den Shop im Frontend <a href="%s" target="_blank">HIER</a> anschauen.</p><p>Sie k&ouml;nnen nun mit der individuellen Anpassung Ihres Shops beginnen. Wir empfehlen Ihnen, einen Blick in die entsprechende Checkliste im Handbuch zu werfen.</p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage08'] = '<h2>MERCONIS %s ist vollst&auml;ndig eingerichtet!</h2>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage09'] = '<h2>Die von Ihnen eingesetzte Contao-Version ist nicht kompatibel mit dieser MERCONIS-Version.</h2>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage10'] = '<p class="shopHint">Wichtiger Hinweis: Der MERCONIS-Installer hat eine mehrsprachige Seitenstruktur angelegt. Damit die Mehrsprachigkeit richtig verarbeitet wird und MERCONIS korrekt dargestellt werden kann, muss die Seite &quot;MERCONIS - Root page (main language)&quot; als Sprachen-Fallback gekennzeichnet werden. Diese Kennzeichnung konnte vom Installer nicht automatisch durchgef&uuml;hrt werden, da m&ouml;glicherweise ein Konflikt mit einer bereits existierenden Root-Seite vorlag. Bitte nehmen Sie die entsprechende Einstellung daher bei Bedarf manuell vor.</p>';

$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage11'] = '<p>Die vorliegende Programmversion weicht vom aktuellen Einrichtungszustand ab. Dies ist in Ordnung, wenn Sie gerade f&uuml;r ein Update die Programmdateien einer neuen MERCONIS-Version eingespielt haben.</p><p><strong>Ihr Einrichtungszustand entspricht Version %s<br />Ihre Programmversion ist %s</strong></p><p class="bottomButton"><a href="%s"><button type="button">Update beginnen</button></a></p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage12'] = 'Anweisungen';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage13'] = '<p><strong>Das Update umfasst mehrere Versionsspr&uuml;nge, die einzeln abgearbeitet werden m&uuml;ssen. Bitte halten Sie sich genau an die vorgegebene Reihenfolge.</strong></p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage14'] = '<p class="bottomButton"><a href="%s" onclick="return confirm(\'Sind sie sicher?\');"><button type="button">Update als erledigt kennzeichnen</button></a></p>';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage16'] = '<p>Folgen Sie nun bitte den verlinkten Anweisungen. Klicken Sie <a href="%s">hier</a>, um das Contao-Install-Tool aufzurufen, wenn Sie in den Anweisungen dazu aufgefordert werden.</p>';

$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage17'] = '<p>Ihre zuletzt installierte Version konnte nicht eindeutig ermittelt werden. Bitte w&auml;hlen Sie, welche Version Sie vor dem Einspielen der neuen Programmdateien installiert hatten.</p>';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage18'] = 'Konvertierungsroutine ausf&uuml;hren';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage19'] = 'Konvertierung wurde durchgef&uuml;hrt';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage20'] = 'Konvertierung noch nicht m&ouml;glich';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage21'] = '<span class="updateLessImportantNote">F&uuml;r diesen Versionssprung ist nichts zu tun.</span>';

$GLOBALS['TL_LANG']['MSC']['ls_shop']['systemMessages']['installToolMessage22'] = '<h2 class="merconisInstallerHeadline">MERCONIS-INSTALLER</h2><p class="shopHint">In Ihrem Projekt ist die automatische Installation nicht m&ouml;glich. Entweder liegt eine abgebrochene oder unvollst&auml;ndig deinstallierte MERCONIS-Installation vor oder andere Umgebungsbedingungen verhindern den Einsatz des Installers.</p><p>Bitte kontaktieren Sie den <strong>MERCONIS techSupport</strong> telefonisch oder per E-Mail, um das Problem zu beheben und/oder Unterst&uuml;tzung bei der MERCONIS-Inbetriebnahme ohne den automatischen Installer zu bekommen. Die Kontaktdaten des <strong>MERCONIS techSupport</strong> finden Sie auf <a href="http://www.merconis.com" target="_blank">www.merconis.com</a></p><p><strong>HINWEIS:</strong> Diese Meldung wird Ihnen auch bei einer eigentlich korrekten und vollst&auml;ndigen MERCONIS-Installation angezeigt, falls in Ihrer localconfig.php der Eintrag &quot;ls_shop_installedCompletely&quot; entfernt wurde bzw. nicht auf &quot;true&quot; steht, was z. B. durch das Zur&uuml;ckspielen einer alten Version Ihrer localconfig.php der Fall sein kann.</p>';
...
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['santanderWebQuick']['misc15'] = 'Als versandt melden';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['santanderWebQuick']['misc16'] = 'Stornieren';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['santanderWebQuick']['misc17'] = 'Erfolgreich storniert';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['santanderWebQuick']['misc18'] = 'Konnte nicht storniert werden';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['santanderWebQuick']['misc19'] = 'Erfolgreich als versandt gemeldet';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['santanderWebQuick']['misc20'] = 'Konnte nicht als versandt gemeldet werden';
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['santanderWebQuick']['misc21'] = 'Wirklich stornieren?';
