...
CREATE TABLE `tl_ls_shop_product` (
	...
	`flex_contents` blob NULL,
	`flex_contentsLanguageIndependent` blob NULL,
	`lsShopProductAttributesValues` blob NULL
	PRIMARY KEY  (`id`),
...
CREATE TABLE `tl_ls_shop_variant` (
	...
	`description` text NULL,
	`published` char(1) NOT NULL default '',
	`lsShopProductVariantAttributesValues` blob NULL,
...
CREATE TABLE `tl_ls_shop_payment_methods` (
  ...
  `feeWeightValues` blob NULL,
  `feePriceValues` blob NULL,
